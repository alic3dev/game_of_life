...
file_cexil_library=${directory_cexil_library}/*.o
file_interrupt_handler_library=${directory_interrupt_handler_library}/*.o
...
cc=gcc
c_flags=-O3 -I${directory_include} -I${directory_cexil_include} -I${directory_interrupt_handler_include}
...
${file_output}: ${files_objects} ${directory_output}
	${cc} ${c_flags} ${file_cexil_library} ${file_interrupt_handler_library} ${files_objects} -o ${file_output}
